...
{
if (e.keyCode >= 65 && e.keyCode <= 90 && !keyInput[e.keyCode] && document.getElementById("bgmCover").style.zIndex==-1)
{
...
function objective()
{
  if (correctltr.length === answerLower.length)
    ...
    else if (attempts === 0)
    {
      ...
      setTimeout(function(){
        document.getElementById("answer").innerHTML = "You died! The correct answer is <font color='blue'>" + answerLower.join("") + "</font>.";
        document.getElementById("retry").style.visibility = "visible";
        $("#retry").on("click", function()
      {
        reset();
...
function reset()
{
  ...
  document.getElementById("attempts").style.color = "black";  document.getElementById("attempts").style.fontSize = "";
...
$("#bgmYes").on("click", function()
{
  document.getElementById("bgm").volume = 0.3;
  document.getElementById("bgm").play();
  soundon = true;
  document.getElementById("bgmCover").style.zIndex=-1;
  document.getElementById("bgmCover").style.display='none';
});
$("#bgmNo").on("click", function()
{
  document.getElementById("bgmbutton").src = "assets/img/soundoff.png";
  soundon = false;
  document.getElementById("bgmCover").style.zIndex=-1;
  document.getElementById("bgmCover").style.display='none';
});
